					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App para gerenciasr ordens de venda",
									"targetURL": "#zjfbov-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zjfbov-display": {
								"semanticObject": "zjfbov",
								"action": "display",
								"description": "App para gerenciasr ordens de venda",
								"title": "App para gerenciasr ordens de venda",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zjfbov",
									"url": sap.ui.require.toUrl("zjfbov")
								}
							}
						}
					}
